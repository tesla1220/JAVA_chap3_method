...
public class Application05 {
    ...
    public static void main(String[] args) {
        ...
        *   void 메소드의 경우 return; 을 명시적으로 작성하지 않아도
        *   마지막 줄에 컴파일러가 자동으로 추가해준다.
        *   return은 현재 메소드를 강제 종료하고, 호출한 구문으로 다시 돌아가는 명령이다.
        *   */
...
//        System.out.println("test");       에러가 발생한다. Unreachable Statement
