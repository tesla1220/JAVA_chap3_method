...
public class Application03 {
    ...
    public static void main(String[] args) {
         ...
         *   다른 메소드 간 서로 공유해야하는 값이 존재하는 경우 메소드 호출 시 사용하는 괄호를 이용해서 값을 전달할 수 있다.
         *   이 때 전달하는 값을 전달인자(argument)라 부르고,
...
//        app3.testMethod("20"); // String
        ...
        long longAge = 80;
//        app3.testMethod(longAge);     // int가 출력값이 되어야 하는데 int보다 큰 long이어서 오류가 난다.
