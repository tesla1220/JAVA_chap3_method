...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        /* 수업목표. java.util.Scanner를 이용한 다양한 자료형 값 받아보기. */
...
//        java.util.Scanner sc = new Scanner(System.in) ;
        ...
        /* 목차. 1-2. 다른 패키지에 있는 클래스 사용 시 패키지명을 생략하기 위해 사용.  */
        ...
        /* 필기. nextLong() : 입력 받은 값을 long형으로 반환한다. */
        ...
        System.out.print("참과 거짓 둘 중 한가지를 true or false로 입력해주세요 : ");
